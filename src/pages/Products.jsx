...
function Products() {
  ...
  return (
    <div className="bg-white min-h-screen py-8 px-4 text-teal-500">
      <h1 className="text-4xl font-bold text-center mb-8 text-teal-700">Products</h1>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {products.map((product) => (
          <div
            key={product.id}
            className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 border border-teal-300 flex flex-col" 
          >
            ...
            <div className="p-4 bg-teal-50 border-t border-teal-200 flex justify-between items-center">
